...
import { ArrowRight, CheckCircle, Download, Mic, Shield, Zap } from 'lucide-react';
    ...
    const features = [
        {
            ...
            description: 'Advanced speech recognition with 99% accuracy using state-of-the-art AI models.',
        },
        {
            icon: Zap,
            title: 'Lightning Fast',
            description: 'Process hours of audio in minutes with our optimized transcription engine.',
        },
        {
            icon: Shield,
            title: 'Secure & Private',
            description: 'Your files are encrypted and never stored permanently. Complete privacy guaranteed.',
        },
        {
            icon: Download,
            title: 'Multiple Formats',
            description: 'Export to PDF, Word, or plain text. Perfect for legal documents and reports.',
        },
    ];

    const pricing = [
        { tokens: 5000, price: 10, minutes: 100 },
        { tokens: 10000, price: 18, minutes: 200, popular: true },
        { tokens: 25000, price: 40, minutes: 500 },
    ];
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <h1 className="mb-6 text-4xl font-bold text-gray-900 lg:text-6xl dark:text-white">
                                Professional{' '}
                                <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Speech-to-Text</span>{' '}
                                Service
                            </h1>
                            <p className="mx-auto mb-8 max-w-3xl text-xl text-gray-600 dark:text-gray-300">
                                Transform your audio and video files into accurate transcriptions with advanced AI. Perfect for lawyers, journalists,
                                researchers, and professionals.
                            </p>
                            <div className="flex flex-col justify-center gap-4 sm:flex-row">
                                <Link
                                    href={route('register')}
                                    className="flex items-center justify-center space-x-2 rounded-lg bg-purple-600 px-8 py-3 text-lg font-medium text-white transition-colors hover:bg-purple-700"
                                >
                            ...
                            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">10,000 free tokens on signup • No credit card required</p>
                        </motion.div>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                            {features.map((feature, index) => (
                                <motion.div
                                    ...
                                    className="rounded-lg p-6 text-center transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                                >
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="mb-16 text-center">
                            <h2 className="mb-4 text-3xl font-bold text-gray-900 lg:text-4xl dark:text-white">Simple, Transparent Pricing</h2>
                            <p className="text-xl text-gray-600 dark:text-gray-300">Pay only for what you use with our token-based system</p>
                        </div>
                        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
                            {pricing.map((plan, index) => (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, delay: index * 0.1 }}
                                    className={`relative rounded-2xl border-2 bg-white p-8 dark:bg-gray-800 ${
                                        plan.popular
                                ...
                                >
                                    {plan.popular && (
                                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 transform">
                                            <span className="rounded-full bg-purple-600 px-4 py-1 text-sm font-medium text-white">Most Popular</span>
                                        </div>
                                    )}
                                    <div className="text-center">
                                        ...
                                        <div className="mb-4">
                                            <span className="text-4xl font-bold text-gray-900 dark:text-white">MYR{plan.price}</span>
                                        </div>
                                        <p className="mb-6 text-gray-600 dark:text-gray-300">~{plan.minutes} minutes of transcription</p>
                                        ...
                                        <Link
                                            href={route('register')}
                                            className={`flex w-full items-center justify-center rounded-lg px-6 py-3 font-medium transition-colors ${
                                                plan.popular
