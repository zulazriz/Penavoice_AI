...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    // return (
    //     <AuthLayout title="Sign in to your account" description="Enter your email and password below to log in">
    //         <Head title="Log in" />
    ...
    //                     <Button type="button" className="w-1/3" tabIndex={3} onClick={() => (window.location.href = '/')}>
    //                         Back
    //                     </Button>
